...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "nn_model"
...
#define AI_NETWORK_IN_1_CHANNEL     (6063)
#define AI_NETWORK_IN_1_SIZE        (6063)
#define AI_NETWORK_IN_1_SIZE_BYTES  (24252)
