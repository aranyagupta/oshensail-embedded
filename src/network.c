...
#define AI_NETWORK_MODEL_SIGNATURE     "0x854a57ebe34aeb4d79075a62632cd1a8"
...
#define AI_TOOLS_DATE_TIME   "Mon Jun  3 17:23:37 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 6063, 8, 1, 1), AI_STRIDE_INIT(4, 4, 24252, 194016, 194016),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 1, 6063, 1, 1), AI_STRIDE_INIT(4, 4, 4, 24252, 24252),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 194660, 1, 1),
    194660, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 24284, 1, 1),
    24284, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 24252);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24252);
    ...
    gemm_1_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    gemm_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    ...
    gemm_2_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    gemm_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 194016);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 194016);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 194048);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 194048);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 194304);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 194304);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 194336);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 194336);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 194592);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 194592);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 194624);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 194624);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 194656);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 194656);
    return true;
  }
